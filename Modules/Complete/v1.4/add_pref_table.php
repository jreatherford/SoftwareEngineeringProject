...
function build_add_pref_table($location)
{
    ...
    echo ("
        ...
        <div style='height:450px;width:300px;overflow:auto;' align='center'>
    ");

    //get the courses
    $raw_course = unserialize(@file_get_contents($_SESSION['DIRECTORY'].INFO_FILE));
    if ($raw_course !== false)
    ...
    foreach ($course as $curr_course)
    {
        ...
        if ($curr_course->section == "internet")
            echo "<tr>
                <td>
                <input type=\"radio\" name=\"course_add\" 
                    value=\"$curr_course->name.i\">
                    </td>";
        else
            echo "<tr>
                <td>
                <input type=\"radio\" name=\"course_add\" 
                    value=\"$curr_course->name\">
                </td>";
        ...
        {
            echo "<input type=\"hidden\" name=\"$curr_course->name.i\" 
                     value=\"internet\">";
    ...
    echo "<tr><td width=\"10px\"></th> 
        <td width=\"80px\" align=\"left\"></td
        <td width=\"50px\" align=\"left\"></td> 
        <td width=\"100px\" align=\"left\"></td></tr>";
