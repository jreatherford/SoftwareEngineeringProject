        ...
        <div id="container">
            ...
            <div id="left_column">
                ...
                <table width="250px" id="table_left_top" cellpadding="5" border="1">
                    ...
                    <tr>
                        <td>
                            <a id="current" href="courseConflict.php">COURSE CONFLICTS</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <a id="not_current" href="admin.php">ACCOUNT MANAGEMENT</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div id="middle_column">
                ...
                <div id="display_area" align="center">
                    ...
                    <?php
                        $info = array();
                        $readFile = @fopen($_ENV['DIRECTORY'].'CF.dat', "r");
                        if ($readFile)
                        {
				...
				<div id="save_discard_buttons">
				    <br />
                                           <input type="hidden" name="input_type" value="CF">
                                <input type="Submit" class="" id="changeSubmit" value="Submit"/>
                                <a href='courseConflict.php' >
            ...
            <div id="footer">
				...
				<a id="bottom_links" href="facultyAccounts.php">ACCOUNT MANAGEMENT</a> |
