        ...
        <div id="container">
            ...
            <div id="left_column">
                ...
                <table width="250px" id="table_left_top" cellpadding="5" border="1">
                    ...
                    <tr>
                        <td>
                            <a id="current" href="">PREREQUISITES</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                ?>
                    ...
                    <?php
                        echo "<form action='prerequisites.php' method='post'>";
            ...
            <div id="middle_column">
                ...
                <div id="display_area" align="center">
                    ...
                    <?php
                        $info = array();
                        $readFile = @fopen($_SESSION['DIRECTORY'].'PR.dat', "r");
                        if ($readFile)
                        {
            ...
            <div id="footer">
				...
				<a id="bottom_links" href="">PREREQUISITES</a> |
