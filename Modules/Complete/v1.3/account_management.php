...
<table style="text-align:center;" cellspacing ="10">
    <tr><th>Admin ID</th><th>Admin name</th><th>Password</th><th>Email</th><th>Hours</th><th>Years of Service</th></tr>
<?php
    foreach($rowsad as $row) {
        ...
        if( $row['hour'] == 0 )
            ...
            echo '<td>'.$row['hour'].'</td>';
        if( $row['year_of_service'] == 0 )
            echo '<td>-</td>';
        else
            echo '<td>'.$row['year_of_service'].'</td></tr>';
    }
?>
</table>
...
<br/>
<br/>
<b>Upload Faculty Members File:</b>
<br/>
<br/>
