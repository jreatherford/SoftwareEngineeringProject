        ...
        <div id="container">
            ...
            <div id="left_column">
                ...
                <table width="250px" id="table_left_top" cellpadding="5" border="1">
                    ...
                    <tr>
                        <td>
                            <a id="current" href="">COURSE CONFLICTS</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                ?>
                    ...
                    <?php
                        echo "<form action='courseConflict.php' method='post'>";
            ...
            <div id="middle_column">
                ...
                <div id="display_area" align="center">
                    ...
                    <?php
                        $info = array();
                        $readFile = @fopen($_SESSION['DIRECTORY'].'CF.dat', "r");
                        if ($readFile)
                        {
            ...
            <div id="footer">
				...
				<a id="bottom_links" href="">COURSE CONFLICTS</a> |
